...
val SYNTAX_DESCRIPTION = "Syntax:\n" +
            "java -jar path_to_material_icons.jar install path_to_zip color size [module_name]\n" +
            "java -jar path_to_material_icons.jar uninstall file_name.png [module_name]\n" +
            "Optional: module_name. Default value = app\n"+
